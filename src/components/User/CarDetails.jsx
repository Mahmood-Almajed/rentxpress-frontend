          ...
          <form onSubmit={handleRent} noValidate>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                pattern="(\+973)?(3(20|21|22|23|80|81|82|83|84|87|88|89|39)[0-9]{5}|33[0-9]{6}|34[0-6][0-9]{5}|35(0|1|3|4|5)[0-9]{5}|36[0-9]{6}|37[0-9]{6}|31[0-9]{6}|66(3|6|7|8|9)[0-9]{5}|6500[0-9]{4}|1[0-9]{7})"
                maxLength={8}
              />
            </div>
            <button
