...
>
  ...
  {/* <h1 className="display-4 fw-bold ">Find Your Perfect Car</h1> */}
...
<motion.h1
  ...
  style={{fontSize: 80}}
>
  Car<span style={{color:"#"}}>X</span>press
</motion.h1>
  ...
  <div className="container">
    <div className="d-flex justify-content-between align-items-center mb-4">
      ...
      <span style={{color:"#06b4d8" , cursor: "pointer"}}>
        <a href="/cars" className="btn" style={{textDecoration: "none", backgroundColor:"#06b4d8"}}>Show All Brands  ↗</a> 
      </span>
    </div>
        ...
        <div className="row g-0">
          ...
          <div className="col-md-6 bg-dark text-white d-flex align-items-center" style={{              
            ...
            <div className="p-md-5 px-4 py-5">
              ...
              <h2 className="mb-4 mt-2 ">Welcome to Car<span style={{color:"#06b4d8"}}>X</span>press</h2>
              ...
              <a href="/cars" className="btn py-2 px-4 mt-2" style={{backgroundColor:"#06b4d8"}}>
                Search Vehicle
              </a>
            </div>
          </div>
