...
function DealerCarsList() {
  ...
  const filteredCars = cars.filter((car) => {
    const matchesFilter =
      filter === "all" ||
      (filter === "rent" && !car.forSale) ||
      (filter === "sale" && car.forSale);
    const matchesSearch =
    ...
    <div className="container my-5">
      <div className="text-center mb-5">
        ...
        <p className="text-muted fs-5">
          Welcome, <strong>{user?.username}</strong>. Below are the cars you've
          listed.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="alert alert-info">
          No cars match your current search or filter.
        </div>
      ) : (
              ...
              >
                ...
                >
                  ...
                  <p className="card-text mb-2">
                    {car.forSale ? (
                      <>
                        BHD <strong>{car.salePrice}</strong>{" "}
